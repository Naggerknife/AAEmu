...
namespace AAEmu.Game.Models.Game.Skills.Effects.SpecialEffects
{
    public class Anim : ISpecialEffect
    {
            ...
            int value1, int value2, int value3, int value4)
        {
            ...
            //caster.BroadcastPacket(new SCPlotEventPacket(caster.TlIdPlot, caster.Step.Event.Id, caster.SkillId, casterPlotObj, targetPlotObj, unkId, time2, caster.Step.Flag, itemId, targetUnitCount), true);
            #endregion
        }
    }
}
