...
namespace AAEmu.Game.Models.Game.Skills
{
    public class SkillModifiers
    {
        ...
        public List<SkillModifier> GetModifiersForSkillIdWithAttribute(uint skillId, SkillAttributeType attribute)
        {
        ...
        public List<SkillModifier> GetModifiersForTagIdWithAttribute(uint tagId, SkillAttributeType attribute)
        {
